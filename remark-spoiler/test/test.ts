...
// project imports
import { SpoilerNode } from 'mdast-util-spoiler';
import { SpoilerSyntaxOptions } from 'micromark-extension-spoiler';
import { spoilerPlugin as remarkSpoilerPlugin } from '..';

// re-use tests from mdast-util-spoiler
import * as MdastUtilSpoilerTests from '../../mdast-util-spoiler/test/test';
